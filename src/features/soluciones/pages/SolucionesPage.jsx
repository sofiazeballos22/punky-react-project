  ...
  const solutions = [
    {
      ...
      description: 'Normativa oficial, recibos de haberes, descuentos, obra social y trámites internos. Reglas específicas por fuerza y protocolo claro para crédito por Decreto 1412.',
      gradientFrom: 'blue',
      badgeBg: 'bg-blue-50',
    ...
    },
    {
      ...
      description: 'Análisis de disponible al instante, sin hojas de cálculo. Explicación de montos, cuotas y límites. Acompañamiento hasta la firma, siempre que sea conveniente para vos.',
    ...
    },
    {
      ...
      description: 'Explicaciones lentas, claras y sin letra chica. Haberes, descuentos, obras sociales, turnos, reclamos y defensa ante cobros indebidos.',
      gradientFrom: 'orange',
    ...
    },
    {
      ...
      description: 'Punky traduce el lenguaje estatal a castellano simple: qué formulario, qué link, qué turno y qué hacer si algo sale mal.',
      gradientFrom: 'violet',
    ...
    },
    {
      ...
      description: 'Compras no entregadas, cargos raros, tarjetas, homebanking y estafas online. Punky te dice qué capturas guardar y dónde reclamar.',
      gradientFrom: 'rose',
      badgeBg: 'bg-rose-50',
    ...
    },
    {
      ...
      description: 'Monotributo, AFIP, ARCA, contratos básicos y dudas legales frecuentes. Primera orientación y organización de tu caso para que llegues mejor a tu profesional.',
      gradientFrom: 'slate',
      badgeBg: 'bg-slate-50',
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 text-center reveal active">
          <button 
            onClick={() => openWhatsApp('Hola Punky, quiero que me ayudes con varios temas.')}
