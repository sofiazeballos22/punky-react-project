      ...
      >
        ...
        <div className="space-y-8 text-center lg:text-left z-20">
          ...
          <p className="reveal active delay-200 text-base md:text-lg text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            <span className="punky-title">Punky</span> es tu asistente
            financiero y social digital. En un solo chat recibís ayuda para
            créditos, fuerzas, jubilaciones, defensa del consumidor, compras,
            trámites, temas legales y contables. Sin filas, sin carpetas,
            explicado en simple.
          </p>
